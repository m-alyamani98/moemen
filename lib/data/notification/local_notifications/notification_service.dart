...
class NotificationController {
  ...
  static Future<void> scheduleNewNotification({
    ...
    var targetDate = DateTime(nowDate.year, nowDate.month, nowDate.day, targetHour, targetMinute);

    // If the target time is in the past, schedule it for the next day
    if (targetDate.isBefore(nowDate)) {
      targetDate = targetDate.add(Duration(days: 1));
    }

    print('Scheduling notification at: ${targetDate.toString()}');
